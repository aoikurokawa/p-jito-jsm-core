...
pub struct ListVaultNcnSlasherTicket {
...
pub async fn command_list_vault_ncn_slasher_ticket(args: ListVaultNcnSlasherTicket) {
    ...
    handler.list_vault_ncn_slasher_ticket().await;
}
